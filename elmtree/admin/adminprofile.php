					...
					while($userrow = $userresult->fetch_assoc()){
						...
						echo "<div class='col-md-5'>
							...
							<div class='col-md-6'>
								...
								<h4 class='toppadding'>Instagram: <a class='badge badge-danger text-dark' href='https://www.instagram.com/$instadata/' target='_blank'>@$instadata</a></h3>";
						...
						echo "<p><a class='btn btn-lg btn-success btn-block' href='messageuser.php?userid=$profileid'>Message User</a></p>";
							
						echo "<p><a class='btn btn-lg btn-warning btn-block' href='editprofile.php?userid=$profileid'><strong>EDIT PROFILE</strong></a><p>
