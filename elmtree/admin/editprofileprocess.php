<?php
	...
	$userid = $conn->real_escape_string($_POST["insertprofileid"]);
	...
	if($errorflag==1){
		$insertquery = "UPDATE elmtree_users SET username='$userpost', password='$passpost', firstName='$firstname', lastName='$lastname', email='$email', phoneNumber='$phone', university='$university', instagramTag='$instagram' WHERE userid='$userid'";
	}else{
		$rand = rand(0, 1000000);
		$filename = $_FILES['uploadProfilePic']['name'];
		...
		$insertquery = "UPDATE elmtree_users SET username='$userpost', password='$passpost', firstName='$firstname', lastName='$lastname', email='$email', phoneNumber='$phone', profileImgPath='$filename', university='$university', instagramTag='$instagram' WHERE userid='$userid'";
	}
