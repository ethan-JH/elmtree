...
?>
    ...
    <section class="jumbotron text-center">
      <div class="container">
        <h1 class="jumbotron-heading">Welcome to Elm Tree Books</h1>
        <p class="lead text-muted"> Elm Tree is a space for students to sell their no longer needed books  to others who need the knowledge more. Login to buy and sell, or register to join the Elm Tree community. </p>
        <p>
